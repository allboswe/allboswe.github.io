(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))u(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&u(i)}).observe(document,{childList:!0,subtree:!0});function d(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function u(t){if(t.ep)return;t.ep=!0;const r=d(t);fetch(t.href,r)}})();const h=document.documentElement,p="theme";function y(){return localStorage.getItem(p)}function f(){const e=h.getAttribute("data-theme");return e==="light"||e==="dark"?e:window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function c(e){const o=document.getElementById("theme-toggle");h.setAttribute("data-theme",e),localStorage.setItem(p,e),o&&o.setAttribute("aria-pressed",String(e==="dark"))}function b(){const e=f();c(e==="dark"?"light":"dark")}function x(){const e=y();c(e==="light"||e==="dark"?e:f()),document.addEventListener("click",o=>{o.target.closest("#theme-toggle")&&b()})}function k(){return`
    <header>
      <h1 class="site-title">
  ...
  `)}const l=document.querySelector("#app"),S={home:v},C=l?.dataset.page||"home",A=S[C]||v;l&&(l.innerHTML=A());x();const s=document.querySelector("#menu-toggle"),n=document.querySelector("#menu"),m=document.querySelector("#menu-close"),g=document.querySelector(".menu-backdrop");function P(){!n||!s||(n.classList.add("is-open"),n.setAttribute("aria-hidden","false"),s.setAttribute("aria-expanded","true"),document.body.classList.add("menu-open"))}function a(){!n||!s||(n.classList.remove("is-open"),n.setAttribute("aria-hidden","true"),s.setAttribute("aria-expanded","false"),document.body.classList.remove("menu-open"))}s&&n&&m&&g&&(s.addEventListener("click",P),m.addEventListener("click",a),g.addEventListener("click",a),document.addEventListener("keydown",e=>{e.key==="Escape"&&n.classList.contains("is-open")&&a()}));
